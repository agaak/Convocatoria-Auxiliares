...
@section('content-convocatory')
    ...
    <div class="overflow-auto content">
        ...
        <form class="form-title-description" method="POST" action="{{ route('request') }}">
            ...
            <div class="form-row my-5">
                ...
                <div class="col-xl input-group date">
                    <input type="text" class="form-control" id="date-ini"><span class="input-group-addon">
                ...
                <div class="col-xl input-group date">
                    <input type="text" class="form-control" id="date-end"><span class="input-group-addon">
                        <svg class="calendar-svg" width="34px" height="34px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M14 0H2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2zM1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857V3.857z" clip-rule="evenodd"/>
                            <path fill-rule="evenodd" d="M6.5 7a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm-9 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm-9 3a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2zm3 0a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/>
                        </svg>
        ...
        <div class="my-5 py-5 text-center">
            ...
            <a href="{{ route('request') }}" class="btn btn-primary text-uppercase" tabindex="-1" role="button" aria-disabled="true">Siguiente</a>
        </div>
