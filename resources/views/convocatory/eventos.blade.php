                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('importantDateSave') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                {!! $errors->first('titulo-evento', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                {!! $errors->first('lugar-evento', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-10">
                              <input class="form-control" type="datetime-local" id="place-event-date-ini" 
                                     name="fecha-ini-evento" required value="{{ old('fecha-ini-evento') }}">
                            </div>
                            <div>
                                {!! $errors->first('fecha-ini-evento', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-10">
                              <input class="form-control" type="datetime-local" id="place-event-date-end" 
                                     name="fecha-fin-evento" required value="{{ old('fecha-fin-evento') }}">
                            </div>
                            <div>
                                {!! $errors->first('fecha-fin-evento', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        @if ($errors->any())
                        <script>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('importantDatesUpdate') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                {!! $errors->first('titulo-evento-edit', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="place-event">Lugar de evento</label>
                            ...
                            <div>
                                {!! $errors->first('lugar-evento-edit', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="place-event-date-ini">Fecha inicial</label>
                            <div class="col-10">
                              <input class="form-control" type="datetime-local" id="fecha-ini-evento-edit" 
                                     name="fecha-ini-evento-edit" required value="{{ old('fecha-ini-evento-edit') }}">
                            </div>
                            <div>
                                {!! $errors->first('fecha-ini-evento-edit', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="place-event-date-end">Fecha final</label>
                            <div class="col-10">
                              <input class="form-control" type="datetime-local" id="fecha-fin-evento-edit" 
                                     name="fecha-fin-evento-edit" required value="{{ old('fecha-fin-evento-edit') }}">
                            </div>
                            <div>
                                {!! $errors->first('fecha-fin-evento-edit', '<strong class="message-error text-danger">:message</strong>') !!}
                            </div>
                        </div>
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a type="button" onclick="editDatesList({{convertir($item)}})" data-toggle="modal" data-target="#importantDatesModalUpdate">
                            <img src="{{ asset('img/pen.png') }}" width="30" height="30">
                        </a>
                        <form class="d-inline" action="{{ route('importantDatesDelete', $item->id) }}" method="POST" id="important-dates-delete">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
